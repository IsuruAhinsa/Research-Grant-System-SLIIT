    ...
    <div class="flex flex-col flex-grow pt-5 overflow-y-auto bg-primary-900">
        <div class="flex items-center justify-center flex-shrink-0 px-4">
            <a href="{{ route('dashboard') }}">
                <x-application-logo-v2-light class="block w-auto fill-current h-10"/>
            </a>
        </div>
        <div class="mt-5 flex-1 flex flex-col">
            <nav class="flex-1 px-2 pb-4 space-y-1">

                <x-sidebar-item title="Dashboard" route="{{ route('dashboard') }}">
                    <x-svg-icon class="mr-3 flex-shrink-0 text-white">
                ...
                <div x-data="{ open: false }">
                    <x-sidebar-item @click="open = !open" route="#">
                        <x-svg-icon class="mr-3 flex-shrink-0 text-white">
                ...
                <x-sidebar-item title="Projects" route="#">
                    <x-svg-icon class="mr-3 flex-shrink-0 text-white">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <x-sidebar-item title="Calendar" route="#">
                    <x-svg-icon class="mr-3 flex-shrink-0 text-white">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <x-sidebar-item title="Documents" route="#">
                    <x-svg-icon class="mr-3 flex-shrink-0 text-white">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <x-sidebar-item title="Downloads" route="#">
                    <x-svg-icon class="mr-3 flex-shrink-0 text-white">
                ...
                <x-sidebar-item title="User Management" route="#">
                    <x-svg-icon class="mr-3 flex-shrink-0 text-white">
