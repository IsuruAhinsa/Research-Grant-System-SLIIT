        ...
        <form class="row" method="POST" action="{{ route('roles.store') }}">
            ...
            <div class="relative w-full sm:max-w-half sm:flex-half space-y-4">
                ...
                <div>
                    ...
                    <x-ui.input id="name" type="text" placeholder="Enter Role Name" class="mt-1 block w-full" name="name" value="{{ old('name') }}"/>
                ...
                <div>
                    ...
                    <label class="flex flex-row items-center py-3 cursor-pointer">
                        <x-ui.checkbox class="text-indigo-600 focus:border-indigo-300 focus:ring-indigo-200" id="checkPermissionAll" value="1" />
