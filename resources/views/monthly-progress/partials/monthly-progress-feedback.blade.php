@if($monthlyProgress->checkExistsGrading())
    ...
    <div class="mt-8 flex flex-col">
        <h2 class="text-2xl mb-2">Monthly Progress Grading Summary</h2>
...
<div class="mt-8 flex flex-col">
    ...
    @forelse($monthlyProgress->monthlyProgressGrades as $grade)
        <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8 mt-4">
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                <div class="overflow-hidden border-4 md:rounded-lg {{ $grade->grade == 'Excellent' || $grade->grade == 'Good' ? 'border-success-500' : 'border-red-500' }}">

                    <table class="min-w-full">
                        <tbody class="{{ $grade->grade == 'Excellent' || $grade->grade == 'Good' ? 'bg-success-100' : 'bg-red-100' }}">
    ...
    @empty
        <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8 mt-4">
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                <div class="overflow-hidden border-4 border-yellow-500 md:rounded-lg">
